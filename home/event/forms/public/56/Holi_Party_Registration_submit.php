...
$sql = "INSERT INTO Holi_Party_Registration (Name,Age,DoB,College) VALUES ('$Name','$Age','$DoB','$College')";
...
if ($id) {
	...
	$sqll = "INSERT INTO Holi_Party_Registration_att (id) VALUES ($id)";	if ($conn->query($sqll) === FALSE) {
			echo "Error: " .$sql."$conn->error";
}
