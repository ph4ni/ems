...
$sql = "INSERT INTO farewell_party_form (Name,phone,date) VALUES ('$Name','$phone','$date')";
...
if ($id) {
	...
	$sqll = "INSERT INTO farewell_party_form_att (id) VALUES ($id)";	if ($conn->query($sqll) === FALSE) {
			echo "Error: " .$sql."$conn->error";
}
